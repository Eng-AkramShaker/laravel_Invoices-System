        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg
                    ...
                    </svg><span class="side-menu__label">المستخدميين</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . $page='mail') }}">قائمة المستخدميين</a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='mail-compose') }}">صلاحيات المستخدميين</a></li>
                ...
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" fill="none" viewBox="0 0 24 24"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M12 6.253v-2.5M6.364 8.634l-1.767-1.768M4.5 12h-2.5m4.5 3.364l-1.767 1.768M12 17.75v2.5m5.636-5.864l1.768 1.768m3.096-7.303h-2.5m-3.364-3.364l1.768-1.767M12 12a3 3 0 100-6 3 3 0 000 6z" />
                    </svg>
